...
<html lang="en">
  ...
  <c:url value="/changePassword" var="urlchangePassword"/> 
    <!-- Left column -->
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        <div class="templatemo-content-container">
          ...
          <h3 style="color: red">${msg}</h3>  <br>
            ...
            <form:form id = "changePassword" modelAttribute="objUser" action="${urlchangePassword}/${objUser.idUser}" class="templatemo-login-form" method="post">
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    <label for="inputFirstName">Mật khẩu hiện tại</label>
