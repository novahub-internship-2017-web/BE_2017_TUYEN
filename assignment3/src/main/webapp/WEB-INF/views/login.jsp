...
<html lang="en">
	...
	<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
		<div class="templatemo-content-widget templatemo-login-widget white-bg">
	        ...
	        <form:form action="${pageContext.request.contextPath}/login" modelAttribute="user" class="templatemo-login-form" method="POST">
	        	<div class="form-group">
	        		<div class="input-group">
		        		<div class="input-group-addon"><i class="fa fa-user fa-fw"></i></div>	        		
		              	<form:input path="email" type="email" class="form-control" placeholder="email@gmail.com"></form:input>          
		          	</div>	
	        	</div>
	        	<div class="form-group">
	        		<div class="input-group">
