...
<html lang="en">
  ...
  <body>
   <c:url value="/" var="urlIndex"/>
  	...
  	<c:url value="/show-editUser" var="urlEditUser"></c:url>
    <!-- Left column -->
      ...
      <div class="templatemo-content col-1 light-gray-bg">
        <div class="templatemo-content-container">
          <div class="templatemo-content-widget white-bg">
            ...
            <form:form action="${editUser}"  class="templatemo-login-form" method="post" enctype="multipart/form-data">
              ...
              <div class="row form-group">
                <div class="col-lg-6 col-md-6 form-group">                  
                    ...
                    <input disabled="disabled" type="password" class="form-control" id="inputNewPassword" value="****">
