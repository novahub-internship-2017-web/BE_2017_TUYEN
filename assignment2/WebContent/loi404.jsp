<%@page import="tuyen.novahub.entities.NguoiDung"%>
...
<body>
 ...
 <div id="clouds">
        ...
        <div class='c'>
            ...
            <a class='btn' href='<%=request.getContextPath()%>/admin/show-editUser?idUser=<%=userinfo.getIdUser()%>'>Về Trang cá nhân</a><br>
		<!-- 	<a class='btn' href="" onclick="history.back(-1)">Về trang trước đó</a> -->
        </div>
</body>
</html>