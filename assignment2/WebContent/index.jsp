<%@page import="tuyen.novahub.dao.ChucVuDao"%>
<%@page import="tuyen.novahub.dao.LoaiCanBoDao"%>
      ...
      <%@include file="inc/header.jsp" %>
       <%
        ...
        <%							
			...
			switch (msg) {
				case 1:%>
				<h3	style='color: #e822e8; font-style: italic ; font-weight: bold;font-size: 20px'>Thêm thành công </h3>
				<% break;
				case 2:%>
				<h3	style='color: #e822e8; font-style: italic ; font-weight: bold ;font-size: 20px'>Sửa thành công </h3>
				<% break;
				case 3:	%>
				<h3	style='color: #e822e8; font-style: italic ; font-weight: bold ; font-size: 20px'>Xóa thành công </h3>
				<% break;
				case 4:%>
				<h3	style='color: red; font-style: italic ; font-weight: bold ;font-size: 20px'>Bạn không có quyền xóa </h3>
				<% break;
				case 5:	%>
				<h3	style='color: red; font-style: italic ;font-size: 20px'>Bạn không có quyền sửa </h3>
				<% break;
				case 7:	%>
				<p style='color: red; font-size: 20px; font-weight: bold ;'>Không tồn tại id</p>
				<% break;
				case 0:%>
				<p style='color: red; font-weight: bold; font-size: 20px'>Lỗi kết nối</p>
				<% break;
				default:
					break;
				}
              ...
              <table class="table table-striped table-bordered templatemo-user-table">
                <thead>
                  <tr>
                    ...
                    typeSort = 2 sortByYear ASC
                     -->
                    <td><a href="<%=request.getContextPath()%>/admin/sort?typeSortName=1" class="white-text templatemo-sort-by">Tên <span class="caret"></span></a></td>
                    <td><a href="<%=request.getContextPath()%>/admin/sort?typeSortYear=3" class="white-text templatemo-sort-by">Năm Sinh <span class="caret"></span></a></td>
