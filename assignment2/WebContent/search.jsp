    ...
    margin-left: 40px !important;">	
      <form  name="searchForm" class="templatemo-search-form" role="search" action="<%=request.getContextPath()%>/admin/search">
          <div class="input-group">
              ...
              <input value="<%=request.getAttribute("search")%>" required="required" type="search" class="form-control" placeholder="Search" name="search" id="srch-term" title = "Tìm kiếm thông tin cán bộ">           
          </div>
        </form>
		...
		<%} %>	
        <h2> Có <%=request.getAttribute("totalResult")%> kết quả tìm kiếm với từ khóa <%=request.getAttribute("search")%></h2>
                ...
                <thead>
                  <tr>
                    ...
                    typeSort = 2 sortByYear ASC
                     -->
                    <td><a href="#" class="white-text templatemo-sort-by">Tên <span class=""></span></a></td>
                    <td><a href="#" class="white-text templatemo-sort-by">Năm Sinh <span class=""></span></a></td>
